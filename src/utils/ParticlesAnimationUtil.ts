...
export class ParticlesAnimationUtil {
    ...
    public static generateRandomAnimatedCircle(maxXPosition:number, maxYPosition:number, maxSpeed:number= 3, radius:number = 4):AnimatedCircle {
    ...
    public static generateRandomAnimatedCircles(quantity:number, maxXPosition:number, maxYPosition:number, maxSpeed:number= 3, radius:number = 4):AnimatedCircle[] {
